    ...
    <div class="bg-gray-300 rounded-sm">
        <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
            <div class="flex items-center justify-center mr-2">
                <button :class="['cursor-pointer', {'text-green-600': isCompleted, 'text-gray-600': !isCompleted}]" @click="onCheckClick()">
            ...
            <div class="w-full">
                <input type="text" placeholder="Digite a sua tarefa" @keyup.enter="updateTodo" v-model="title" class=" bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3">
            </div>

            <div class="ml-auto flex items-center justify-center">
                <button class="focus:outline-none cursor-pointer" @click="onDelete()">
